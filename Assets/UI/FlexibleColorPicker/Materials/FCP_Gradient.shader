    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_full v)
            {
                ...
                {
                default:
                    o.col.a = lerp(_Color1.a, _Color2.a, v.texcoord.x);
                    o.col = lerp(_Color1, _Color2, v.texcoord.x);
                    break;
                case 1:
                    o.col = lerp(_Color1, _Color2, v.texcoord.y);
                    break;
                case 2:
                    switch (_DoubleMode)
                    {
                    default:
                        _HSV.x = lerp(_HSV_MIN.x, _HSV_MAX.x, v.texcoord.x);
                        _HSV.y = lerp(_HSV_MIN.y, _HSV_MAX.y, v.texcoord.y);
                        break;
                    case 1:
                        _HSV.x = lerp(_HSV_MIN.x, _HSV_MAX.x, v.texcoord.x);
                        _HSV.z = lerp(_HSV_MIN.z, _HSV_MAX.z, v.texcoord.y);
                        break;
                    case 2:
                        _HSV.x = lerp(_HSV_MIN.x, _HSV_MAX.x, v.texcoord.y);
                        _HSV.y = lerp(_HSV_MIN.y, _HSV_MAX.y, v.texcoord.x);
                        break;
                    case 3:
                        _HSV.y = lerp(_HSV_MIN.y, _HSV_MAX.y, v.texcoord.x);
                        _HSV.z = lerp(_HSV_MIN.z, _HSV_MAX.z, v.texcoord.y);
                    ...
                    case 4:
                        _HSV.x = lerp(_HSV_MIN.x, _HSV_MAX.x, v.texcoord.y);
                        _HSV.z = lerp(_HSV_MIN.z, _HSV_MAX.z, v.texcoord.x);
                        break;
                    case 5:
                        _HSV.y = lerp(_HSV_MIN.y, _HSV_MAX.y, v.texcoord.y);
                        _HSV.z = lerp(_HSV_MIN.z, _HSV_MAX.z, v.texcoord.x);
